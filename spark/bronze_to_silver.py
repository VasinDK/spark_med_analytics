...
spark = SparkSession.builder \
    ...
    .config("spark.sql.catalog.yandex.aws.credentials.provider", "com.amazonaws.auth.InstanceProfileCredentialsProvider") \
...
spark.sql(f"""
    ...
    WHEN NOT MATCHED THEN
        ...
        VALUES (td.new_uuid, td.visit_date, td.age, td.gender_id, td.profession_id, td.doctor_id, td.department_id, td.snils, td.height, td.weight, 
